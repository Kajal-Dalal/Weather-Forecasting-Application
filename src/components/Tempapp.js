    ...
    <>
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-center">
          <a className="btn btn-ghost normal-case text-3xl font-Raleway">
            Weather App
          </a>
        </div>
        <div className="navbar-end  pr-5">
          <button className="btn btn-ghost btn-circle">
         <a className="indicator"  href="https://github.com/Kajal-Dalal">
            <svg
          ...
          <button className="btn btn-ghost btn-circle">
            <a className="indicator" href="https://www.linkedin.com/in/kajal-dalal-/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="2em"
                viewBox="0 0 448 512"
